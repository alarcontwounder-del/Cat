  ...
  return (
    <div className="flip-card-front bg-white border border-stone-100 shadow-sm rounded-2xl">
      ...
      <div className="p-5 pt-4">
        ...
        <p className="text-stone-500 text-sm mb-4 line-clamp-2">{h.description}</p>
        ...
        <button className="md:hidden text-xs font-medium flex items-center gap-1" style={{ color: '#f6416c' }}><Eye className="w-3 h-3" /> View Details</button>
      </div>
    </div>
  );
}
