...
export function HotelCardBack(props) {
  ...
  return (
    <div className="flip-card-back rounded-2xl p-6 text-white flex flex-col items-center justify-center" style={{ background: 'linear-gradient(135deg, #f6416c 0%, #e8365f 40%, #d42a52 100%)' }}>
      ...
      <a href="/#contact" className="w-full inline-flex items-center justify-center gap-1.5 bg-white/15 text-white px-5 py-2 rounded-full text-xs font-medium hover:bg-white/25 transition-all border border-white/30" onClick={function(e) { e.stopPropagation(); }}>
        Request a Quote
      </a>
    </div>
  );
