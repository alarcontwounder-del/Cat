...
async def send_contact_email(request: Request):
    ...
    from email_templates import build_admin_email, build_client_email
    html_content = build_admin_email(name, email, dates, message)
    client_html = build_client_email(name, message)
